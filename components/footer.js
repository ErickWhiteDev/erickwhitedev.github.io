...
let footer = `
    ...
    <div class="page-end">
        ...
        <a class="social-link" href="https://github.com/ErickWhiteDev" target="_blank" rel="noopener noreferrer">
            <svg>
                <use href="assets/svg/github-logo.svg#github-logo"/>
            </svg>
        </a>
        <a class="social-link" href="mailto:erickwhitebusiness@gmail.com" target="_blank" rel="noopener noreferrer">
            <svg>
